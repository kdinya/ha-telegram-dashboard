...
(function() {
  const TRANSLATIONS = {
    en: {
      ...
      domain_media_player: "🔊 Media Player",
      domain_cover: "🪟 Covers",
    ...
    uk: {
      ...
      domain_all: "Всі",
      domain_light: "💡 Світло",
      domain_switch: "🔀 Перемикачі",
      domain_climate: "🌡 Клімат",
      domain_sensor: "📈 Сенсори",
      domain_binary_sensor: "🚨 Датчики",
      domain_automation: "⚡ Автоматизації",
      domain_script: "📜 Скрипти",
      domain_media_player: "🔊 Мультимедіа",
      domain_cover: "🪟 Штори",
