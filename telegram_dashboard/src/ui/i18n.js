...
(function() {
  const TRANSLATIONS = {
    en: {
      ...
      btn_edit_item_title: "Edit",
      drag_handle_title: "Drag to change order",
      drag_handle_aria: "Drag item",
      toast_order_updated: "Element order updated",
            btn_lock: "Lock from editing/deletion",
      btn_unlock: "Unlock element",
      badge_locked: "Locked",
      toast_item_locked: "Element locked from edits and deletion",
      toast_item_unlocked: "Element unlocked",
      toast_item_is_locked: "Element is locked. Unlock it to edit or delete.",
btn_action_add_divider: "Add spacer",
      ...
      btn_save_item_title: "Apply to preview",
      ...
      btn_save_section_meta: "Apply",
      btn_save: "Save",
      save_flow_hint: "Local buttons apply changes to the preview. Use the main Save changes button to persist them.",
      label_section_command: "Telegram command to open this section (optional)",
      placeholder_section_command: "/dashboard",
      section_command_hint: "If set, this command opens the section from Telegram. Leave empty if you do not need a separate command.",
      ...
      user_name_placeholder: "e.g. Alex",
      toast_user_added: "User added successfully",
      toast_user_invalid_id: "Please enter a valid numeric Telegram ID",
      preview_closed_msg: "💬 Message closed (removed from chat)",
      preview_reopen_btn: "🔄 Reopen",
      hint_no_entities: "No indicators added yet. Click «+ Add indicator».",
      hint_no_buttons: "No buttons added yet. Click «+ Add button».",
      hint_no_devices: "No devices added yet. Click «+ Add device from list».",
      toast_device_added: "Device added",
      toast_indicator_added: "Indicator added",
      toast_action_pressed: "Action triggered: ",
    ...
    uk: {
      ...
      btn_move_up: "Вгору",
      btn_move_down: "Вниз",
      btn_edit_item_title: "Редагувати",
      drag_handle_title: "Перетягніть для зміни порядку",
      drag_handle_aria: "Перетягнути елемент",
      toast_order_updated: "Порядок елементів оновлено",
            btn_lock: "Заблокувати від змін та видалення",
      btn_unlock: "Розблокувати елемент",
      badge_locked: "Захищено",
      toast_item_locked: "Елемент заблоковано від змін та видалення",
      toast_item_unlocked: "Елемент розблоковано",
      toast_item_is_locked: "Елемент заблоковано. Зніміть замок для редагування чи видалення.",
btn_action_add_divider: "Додати відступ",
      ...
      btn_save_item_title: "Застосувати до превʼю",
      ...
      btn_save_section_meta: "Застосувати",
      btn_save: "Зберегти",
      save_flow_hint: "Локальні кнопки застосовують зміни до превʼю. Основна кнопка «Зберегти зміни» записує їх у конфігурацію.",
      label_section_command: "Команда Telegram для відкриття цього розділу (необовʼязково)",
      placeholder_section_command: "/dashboard",
      section_command_hint: "Якщо вказати команду, вона відкриватиме цей розділ у Telegram. Залиште поле порожнім, якщо окрема команда не потрібна.",
      ...
      user_name_placeholder: "напр. Олексій",
      toast_user_added: "Користувача успішно додано",
      toast_user_invalid_id: "Введіть коректний числовий Telegram ID",
      preview_closed_msg: "💬 Повідомлення закрито (видалено з чату)",
      preview_reopen_btn: "🔄 Відкрити знову",
      hint_no_entities: "Ентіті ще не додані. Натисніть «+ Додати ентіті».",
      hint_no_buttons: "Кнопки ще не додані. Натисніть «+ Додати кнопку».",
      hint_no_devices: "Пристрої ще не додані. Натисніть «+ Додати пристрій зі списку».",
      toast_device_added: "Пристрій додано",
      toast_indicator_added: "Показник додано",
      toast_action_pressed: "Натиснуто: ",
      status_pending_confirm: "Очікує підтвердження",
      status_confirmed: "Підтверджено",
      fallback_user_name: "Користувач",
    }
  };
